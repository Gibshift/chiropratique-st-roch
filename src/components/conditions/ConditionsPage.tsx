  ...
  return (
    <main className="relative bg-white text-zinc-950 isolate">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[460px_1fr_280px] lg:min-h-[360px]">
              ...
              <div className="flex flex-col justify-center py-8 lg:py-12 lg:pr-16">
                ...
                <div className="mt-8 flex flex-wrap items-center gap-3">
                  ...
                  >
                    <span className="whitespace-nowrap">Je ne sais pas trop</span>
                    <svg aria-hidden="true" viewBox="0 0 20 12" className="h-3 w-5 flex-shrink-0 transition duration-200 group-hover:translate-y-0.5">
                ...
                {categories.docs.map((category: any) => {
                  ...
                  return (
                    <a
                      ...
                      className="group flex items-center justify-between border border-zinc-300 bg-white px-4 py-3 transition hover:border-zinc-400 hover:bg-[#f6f1e8]"
                    >
      ...
      {categories.docs.length > 0 && (
        <section id="conditions-grid" className="relative z-10 -mt-4 bg-[#f6f1e8] py-14 lg:py-24 shadow-[0_-12px_32px_rgba(0,0,0,0.14)]">
          <ScrollReveal>
            <div className="relative z-10 mx-auto max-w-[1200px] px-6 lg:px-8">
                ...
                {categories.docs.map((category: any) => {
                  ...
                  return (
                    <a
                      key={category.id}
                      href={`/conditions-traitees/${category.slug}`}
                      className="group flex flex-col bg-white border border-zinc-300 px-5 py-6 transition hover:border-zinc-400 hover:shadow-sm"
                    >
      ...
      <section id="bien-sorienter" className="relative z-20 -mt-4 bg-white py-14 lg:py-24 shadow-[0_-12px_32px_rgba(0,0,0,0.14)]">
        <ScrollReveal>
          <div className="relative z-10 mx-auto max-w-[1200px] px-6 lg:px-8">
            ...
            <div className="mt-10 grid grid-cols-1 gap-4 md:grid-cols-3">
              ...
              {/* Étape 1 */}
              <div className="relative min-h-[190px] overflow-hidden border border-zinc-300 bg-white px-7 py-7 pb-[130px] sm:pb-7 sm:pr-[150px]">
              ...
              {/* Étape 3 */}
              <div className="grid grid-cols-[1fr_auto] gap-4 border border-zinc-300 bg-white px-7 py-7">
                <div>
                  <div className="flex gap-2">
            ...
            <div className="mt-6 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
              <a
                href="/contact"
                className="group inline-flex w-full items-center justify-center gap-3 border border-red-600 bg-red-600 px-6 min-h-[48px] text-[12px] font-bold uppercase tracking-[0.16em] text-white transition hover:bg-white hover:text-red-600 sm:w-auto"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group inline-flex w-full items-center justify-center gap-3 border border-red-600 px-6 min-h-[48px] text-[12px] font-bold uppercase tracking-[0.16em] text-red-600 transition hover:bg-red-600 hover:text-white sm:w-auto"
              >
                <span className="whitespace-nowrap">Prendre rendez-vous</span>
