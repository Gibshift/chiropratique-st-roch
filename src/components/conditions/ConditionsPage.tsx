...
export async function ConditionsPage() {
  ...
  return (
    <main className="relative bg-white text-zinc-950 isolate">
      ...
      <section id="bien-sorienter" className="bg-white py-20">
        <ScrollReveal>
          <div className="relative z-10 mx-auto max-w-[1200px] px-6 lg:px-8">
            ...
            <div className="mt-6 grid grid-cols-3 gap-4">
              <div className="pointer-events-none col-start-1 col-end-3 row-start-1 flex justify-center">
                <a
                  href="/contact"
                  className="pointer-events-auto group inline-flex items-center gap-3 bg-red-600 px-6 min-h-[46px] text-[12px] font-bold uppercase tracking-[0.16em] text-white transition hover:bg-red-700"
                >
              ...
              <div className="pointer-events-none col-start-2 col-end-4 row-start-1 flex justify-center">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="pointer-events-auto group inline-flex items-center gap-3 border border-zinc-300 px-6 min-h-[46px] text-[12px] font-bold uppercase tracking-[0.16em] text-zinc-600 transition hover:border-zinc-950 hover:text-zinc-950"
                >
                  <span>Prendre rendez-vous</span>
